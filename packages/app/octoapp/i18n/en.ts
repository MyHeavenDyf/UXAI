export const dict = {
  ...
  "settings.general.projectDir.description": "The directory used by all pages (Insight, Design) for creating sessions.",
  ...
  "settings.mcp.server.title": "MCP Servers",
  "settings.mcp.server.add": "Add server",
  "settings.mcp.section.builtin": "Built-in",
  "settings.mcp.builtin.empty": "No built-in MCP servers found",
  "settings.mcp.tag.builtin": "built-in",
  "settings.mcp.link.homepage": "Homepage",
  "settings.mcp.link.docs": "Docs",
  "settings.mcp.section.custom": "Custom",
  "settings.mcp.custom.empty": "No custom MCP servers added",
  "settings.mcp.custom.add": "Add MCP",
  "settings.mcp.custom.add.description": "Supports stdio / http / sse types. Connects automatically after saving.",
  "settings.mcp.custom.desktopOnly": "Custom MCP management is desktop only",
  "settings.mcp.type.stdio": "stdio",
  "settings.mcp.type.http": "http",
  "settings.mcp.type.sse": "sse",
  "settings.mcp.delete.title": "Delete MCP",
  "settings.mcp.delete.confirm": "Delete \"{{name}}\"? This removes the MCP entry from the config file.",
  "settings.mcp.toast.saved.title": "MCP saved, reconnecting",
  "settings.mcp.toast.deleted.title": "MCP deleted",
  "settings.mcp.toast.failed.title": "MCP config operation failed",
  "settings.mcp.form.title.add": "Add MCP",
  "settings.mcp.form.title.edit": "Edit MCP",
  "settings.mcp.form.field.name.label": "Name",
  "settings.mcp.form.field.name.placeholder": "my-server",
  "settings.mcp.form.field.name.description": "Letters, digits, underscores and hyphens only",
  "settings.mcp.form.field.type.label": "Type",
  "settings.mcp.form.field.json.label": "JSON parameters",
  "settings.mcp.form.field.homepage.label": "Homepage URL",
  "settings.mcp.form.field.docs.label": "Docs URL",
  "settings.mcp.form.back": "Back to MCP list",
  "settings.mcp.form.back.short": "Back",
  "settings.mcp.form.template.label": "Select MCP type",
  "settings.mcp.form.template.custom": "Custom",
  "settings.mcp.form.template.fetch": "fetch",
  "settings.mcp.form.template.time": "time",
  "settings.mcp.form.template.memory": "memory",
  "settings.mcp.form.template.context7": "context7",
  "settings.mcp.form.json.full": "Full JSON configuration",
  "settings.mcp.form.wizard": "Configuration wizard",
  "settings.mcp.form.wizard.title": "MCP configuration wizard",
  "settings.mcp.form.wizard.description": "Quickly configure an MCP server and generate its JSON configuration",
  "settings.mcp.form.field.wizardName.label": "MCP title (unique)",
  "settings.mcp.form.field.command.label": "Command",
  "settings.mcp.form.field.command.placeholder": "npx or uvx",
  "settings.mcp.form.field.args.label": "Arguments",
  "settings.mcp.form.field.environment.label": "Environment variables",
  "settings.mcp.form.field.headers.label": "Request headers (optional)",
  "settings.mcp.form.hint.transport": "Transport is pinned to the selected type (no automatic fallback).",
  "settings.mcp.form.err.name.required": "Name is required",
  "settings.mcp.form.err.name.invalid": "Name allows letters, digits, underscores and hyphens only",
  "settings.mcp.form.err.name.duplicate": "This name is already in use",
  "settings.mcp.form.err.json.required": "JSON parameters are required",
  "settings.mcp.form.err.json.invalid": "Invalid JSON",
  "settings.mcp.form.err.json.object": "JSON must be an object",
  "settings.mcp.form.err.json.command": "stdio requires a non-empty command array of strings",
  "settings.mcp.form.err.json.url": "A valid url field is required (http/https)",
  "settings.mcp.form.err.homepage": "Homepage must be a valid http/https URL",
  "settings.mcp.form.err.docs": "Docs must be a valid http/https URL",
