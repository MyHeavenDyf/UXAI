...
export const dict = {
  ...
  "settings.mcp.server.title": "MCP 服务器",
  "settings.mcp.server.add": "添加服务器",
  "settings.mcp.section.builtin": "内置",
  "settings.mcp.builtin.empty": "未发现内置 MCP",
  "settings.mcp.tag.builtin": "内置",
  "settings.mcp.link.homepage": "主页",
  "settings.mcp.link.docs": "文档",
  "settings.mcp.section.custom": "自定义",
  "settings.mcp.custom.empty": "未添加自定义 MCP",
  "settings.mcp.custom.add": "添加 MCP",
  "settings.mcp.custom.add.description": "支持 stdio / http / sse 三种类型,保存后自动连接。",
  "settings.mcp.custom.desktopOnly": "自定义 MCP 管理仅支持桌面端",
  "settings.mcp.type.stdio": "stdio",
  "settings.mcp.type.http": "http",
  "settings.mcp.type.sse": "sse",
  "settings.mcp.delete.title": "删除 MCP",
  "settings.mcp.delete.confirm": "确定删除 \"{{name}}\"?该操作会从配置文件中移除此 MCP 条目。",
  "settings.mcp.toast.saved.title": "MCP 已保存,正在重新连接",
  "settings.mcp.toast.deleted.title": "MCP 已删除",
  "settings.mcp.toast.failed.title": "MCP 配置操作失败",
  "settings.mcp.form.title.add": "添加 MCP",
  "settings.mcp.form.title.edit": "编辑 MCP",
  "settings.mcp.form.field.name.label": "名称",
  "settings.mcp.form.field.name.placeholder": "my-server",
  "settings.mcp.form.field.name.description": "仅支持字母、数字、下划线和连字符",
  "settings.mcp.form.field.type.label": "类型",
  "settings.mcp.form.field.json.label": "JSON 参数",
  "settings.mcp.form.field.homepage.label": "主页链接",
  "settings.mcp.form.field.docs.label": "文档链接",
  "settings.mcp.form.back": "返回 MCP 列表",
  "settings.mcp.form.back.short": "返回",
  "settings.mcp.form.template.label": "选择 MCP 类型",
  "settings.mcp.form.template.custom": "自定义",
  ...
  "settings.mcp.form.json.full": "完整的 JSON 配置",
  "settings.mcp.form.wizard": "配置向导",
  "settings.mcp.form.wizard.title": "MCP 配置向导",
  "settings.mcp.form.wizard.description": "快速配置 MCP 服务器，自动生成 JSON 配置",
  "settings.mcp.form.field.wizardName.label": "MCP 标题（唯一）",
  "settings.mcp.form.field.command.label": "命令",
  "settings.mcp.form.field.command.placeholder": "npx 或 uvx",
  "settings.mcp.form.field.args.label": "参数",
  "settings.mcp.form.field.environment.label": "环境变量",
  "settings.mcp.form.field.headers.label": "请求头（可选）",
  "settings.mcp.form.hint.transport": "transport 将固定为所选类型,不再自动降级。",
  "settings.mcp.form.err.name.required": "请输入名称",
  "settings.mcp.form.err.name.invalid": "名称仅支持字母、数字、下划线和连字符",
  "settings.mcp.form.err.name.duplicate": "该名称已被使用",
  "settings.mcp.form.err.json.required": "请输入 JSON 参数",
  "settings.mcp.form.err.json.invalid": "JSON 格式错误",
  "settings.mcp.form.err.json.object": "JSON 必须是一个对象",
  "settings.mcp.form.err.json.command": "stdio 类型需要非空的 command 字符串数组",
  "settings.mcp.form.err.json.url": "需要合法的 url 字段(http/https)",
  "settings.mcp.form.err.homepage": "主页链接必须是合法的 http/https URL",
  "settings.mcp.form.err.docs": "文档链接必须是合法的 http/https URL",
