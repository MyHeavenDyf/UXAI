...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 OctoAI Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "OctoAI 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 OctoAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "OctoAI Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.octoAi.description": "Octo Agent 提供自建的高性能 AI 模型服务，输入你的 API 密钥即可开始使用。",
  "category.dev": "开发",
  "category.design": "设计",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 OctoAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 OctoAI 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 OctoAI 服务器。",
  ...
  "toast.update.description": "OctoAI 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 OctoAI 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: OctoAI 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "OctoAI 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 OctoAI 服务器。",
  ...
  "settings.general.row.language.description": "更改 OctoAI 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 OctoAI 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 OctoAI 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 OctoAI 的主题。",
  ...
  "settings.updates.row.startup.description": "在 OctoAI 启动时自动检查更新",
