...
export function ProjectProductSelect(props: ProjectProductSelectProps): JSX.Element {
  ...
  return (
    <Popover
      ...
      trigger={
        <>
          <span style={{ flex: "1", "text-align": "left", "min-width": "0", overflow: "hidden", "text-overflow": "ellipsis", "white-space": "nowrap", color: props.product ? "#191919" : "#AEAEAE" }}>{selectedLabel()}</span>
