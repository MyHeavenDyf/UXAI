...
export function TitlebarSimple(props: {
  activeTab: () => TabType
  ...
  return (
    ...
    >
      ...
      >
        <div
          class="flex items-center rounded-full bg-[rgba(0,0,0,0.05)] p-1"
          role="tablist"
        >
          {TAB_ITEMS.map((item) => (
            <button
              ...
              classList={{
                ...
                "text-text-weak hover:text-text-base": props.activeTab() !== item.key,
              }}
