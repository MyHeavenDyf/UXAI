...
import {
  ...
  SettingsIcon,
  Section, sideToProp, readableContentName,
  QuadModeSection, EffectsSection,
  LAYOUT_GRID,
} from './row-primitives'
    ...
    <div class="cc-inspector">
      ...
      <Show when={props.targetKind === 'container' || props.targetKind === 'image' || props.targetKind === 'token'}>
        <QuadModeSection
          ...
          onChange={(side, value) => u(sideToProp('padding', side) as keyof ManualEditStyles, value)}
        />
        ...
        <QuadModeSection
          ...
          onChange={(side, value) => u(sideToProp('margin', side) as keyof ManualEditStyles, value)}
        />
      </Show>
