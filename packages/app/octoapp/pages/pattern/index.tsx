...
export default function PatternPage() {
  ...
  function updatePreviewScale() {
    ...
    const containerWidth = previewContainerRef.clientWidth - 40
    const containerHeight = previewContainerRef.clientHeight - 40
  ...
  createEffect(() => {
    ...
    if (previewContainerRef) observer.observe(previewContainerRef)
  ...
  return (
    <DataProvider data={dataStore} directory={homeDir() || ""}>
      <div class="size-full flex overflow-hidden relative">
        ...
        <div ref={previewContainerRef} class="flex-1 min-w-0 overflow-hidden relative" style={{ background: "var(--octo-surface-result)", display: "flex", "justify-content": "center", "align-items": "center" }}>
          <div class="absolute right-[12px] top-[12px] flex gap-[6px]" style={{ "z-index": 10 }}>
            ...
            <button
              ...
              title="全屏"
              onClick={() => {
                if (previewContainerRef?.requestFullscreen) previewContainerRef.requestFullscreen()
              }}
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" width="16" height="16">
          ...
          <div
            ...
            style={{ width: "1920px", height: "1280px", transform: `scale(${previewScale()})` }}
          >
            <iframe
