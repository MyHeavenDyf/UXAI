...
export const STUDIO_STYLE_MODELS = [
  ...
  { id: "hdesign", label: "H Design 3D", icon: "/studio/studioModel13.png", color: "linear-gradient(135deg, #bae6fd, #ffffff)" },
  { id: "hongmeng", label: "鸿蒙插画", icon: "/studio/studioModel10.png", color: "linear-gradient(135deg, #fed7aa, #fecaca)" },
  { id: "hdesign-illustration", label: "H Design插画", icon: "/studio/studioModel14.png", color: "linear-gradient(135deg, #93c5fd, #f5f3ff)" },
