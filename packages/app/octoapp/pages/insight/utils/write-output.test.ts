...
// findWriteOnlyCards / findEditCards(artifact-file-write/edit 前端打点的检测函数)已随
// 统计产物打点全迁服务端删除(SPEC-INS-033 D4),对应测试段一并移除;归因的服务端口径
// 由 packages/opencode/test/tracking/report.test.ts 覆盖。
