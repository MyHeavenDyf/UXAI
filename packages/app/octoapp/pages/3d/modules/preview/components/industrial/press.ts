...
/** 注册 press 组件到 ComponentRegistry */
export function registerPress(registry: ComponentRegistry): void {
  registry.register("press", buildPress)
}
...
function buildPress(
  ...
  const geo = pool.getGeometry(
    `press:placeholder:${width},${height},${depth}`,
