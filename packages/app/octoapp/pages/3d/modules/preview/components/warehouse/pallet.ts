...
/** 注册 pallet 组件到 ComponentRegistry */
export function registerPallet(registry: ComponentRegistry): void {
  registry.register("pallet", buildPallet)
}
