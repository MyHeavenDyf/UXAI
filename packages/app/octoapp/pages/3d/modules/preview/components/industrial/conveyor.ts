...
/** 注册 conveyor 组件到 ComponentRegistry */
export function registerConveyor(registry: ComponentRegistry): void {
  registry.register("conveyor", buildConveyor)
}
...
function buildConveyor(
  ...
  const geo = pool.getGeometry(
    `conveyor:placeholder:${width},${height},${depth}`,
