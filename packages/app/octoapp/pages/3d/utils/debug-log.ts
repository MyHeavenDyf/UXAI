...
export type DebugPhase = "intent_confirm" | "planner" | "modules" | "modify" | "modify_triage" | "modify_planner" | "create" | "template" | "error" | "create_intent" | "create_planner" | "create_modules_merged" | "modify_modules_merged"

const DEBUG_LOG_PREFIX = "octo:scene3d:debug-log"
...
export async function saveDebugSnapshot(
  ...
  opts?: {
    ...
    // 3D 专属（对齐 SceneSessionState 字段）
    lastSceneObjects?: unknown
    modulesJson?: unknown
    sceneConfig?: unknown
    summary?: string
