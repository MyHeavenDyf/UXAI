...
// test/preload.ts pins OCTO_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.OCTO_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.OCTO_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.OCTO_MODELS_PATH = undefined
  Flag.OCTO_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.OCTO_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.OCTO_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
