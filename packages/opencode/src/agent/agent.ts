...
import {
  ...
  PROMPT_SCENE_3D_INTENT,
  PROMPT_SCENE_3D_INTENT_CONFIRM,
  PROMPT_SCENE_3D_INTENT_AUDIT,
  PROMPT_SCENE_3D_PLANNER_CREATE,
  PROMPT_SCENE_3D_PLANNER_MODIFY,
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          // ── 3D 场景生成 agent（克隆 pattern proto_* 语义，适配 SceneConfig，无 load_components_docs 工具）──
          scene_3d_intent_confirm: {
            name: "scene_3d_intent_confirm",
            description: "3D scene intent confirm agent.",
            prompt: PROMPT_SCENE_3D_INTENT_CONFIRM,
            permission: Permission.fromConfig({ "*": "deny" }),
            options: {},
            mode: "primary",
            native: false,
          ...
          scene_3d_intent: {
            name: "scene_3d_intent",
            description: "3D scene intent expansion agent.",
            prompt: PROMPT_SCENE_3D_INTENT,
            permission: Permission.fromConfig({ "*": "deny" }),
            options: {},
            mode: "primary",
            native: false,
          ...
          scene_3d_intent_audit: {
            name: "scene_3d_intent_audit",
            description: "3D scene intent audit agent.",
            prompt: PROMPT_SCENE_3D_INTENT_AUDIT,
            permission: Permission.fromConfig({ "*": "deny" }),
            options: {},
            mode: "primary",
            native: false,
          ...
          scene_3d_planner_create: {
            name: "scene_3d_planner_create",
            description: "3D scene planner create agent.",
            prompt: PROMPT_SCENE_3D_PLANNER_CREATE,
            permission: Permission.fromConfig({ "*": "deny" }),
            options: {},
            mode: "primary",
            native: false,
          ...
          scene_3d_planner_modify: {
            name: "scene_3d_planner_modify",
            description: "3D scene planner modify agent.",
            prompt: PROMPT_SCENE_3D_PLANNER_MODIFY,
            permission: Permission.fromConfig({ "*": "deny" }),
            options: {},
            mode: "primary",
            native: false,
          ...
          scene_3d_module_create: {
            name: "scene_3d_module_create",
            description: "3D scene module create agent.",
            prompt: PROMPT_SCENE_3D_MODULE_CREATE,
            permission: Permission.fromConfig({ "*": "deny" }),
            options: {},
            mode: "primary",
            native: false,
          ...
          scene_3d_module_modify: {
            name: "scene_3d_module_modify",
            description: "3D scene module modify agent.",
            prompt: PROMPT_SCENE_3D_MODULE_MODIFY,
            permission: Permission.fromConfig({ "*": "deny" }),
            options: {},
            mode: "primary",
            native: false,
