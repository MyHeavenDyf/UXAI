    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          proto_page_create: {
            name: "proto_page_create",
            description: "Proto page create agent.",
            prompt: PROMPT_PROTO_PAGE_CREATE,
            permission: Permission.fromConfig({ "*": "deny", load_components_docs: "allow", write: "allow", read: "allow", request_pattern: "allow" }),
            options: {},
            mode: "primary",
            native: false,
            temperature: 0.0,
          ...
          proto_pattern_page: {
            ...
            description: "Proto pattern page agent.",
