...
const api: ElectronAPI = {
  ...
  setWindowMaximized: (maximized) => ipcRenderer.invoke("set-window-maximized", maximized),
  showFullscreenOverlay: (imageUrl) => ipcRenderer.invoke("show-fullscreen-overlay", imageUrl),
  hideFullscreenOverlay: () => ipcRenderer.invoke("hide-fullscreen-overlay"),
