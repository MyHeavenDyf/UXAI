...
const api: ElectronAPI = {
  ...
  getPatternIndex: (category) => ipcRenderer.invoke("get-pattern-index", category),
  getPatternFile: (category, filename) => ipcRenderer.invoke("get-pattern-file", category, filename),
