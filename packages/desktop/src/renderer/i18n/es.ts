export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Octo Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Octo Agent. ¿Quieres instalarla y reiniciar?",
