export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Octo Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Octo Agent er lastet ned. Vil du installere den og starte på nytt?",
