export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Octo Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Octo Agent a été téléchargée. Voulez-vous l'installer et redémarrer ?",
