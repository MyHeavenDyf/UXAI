export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Octo Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Octo Agent wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
