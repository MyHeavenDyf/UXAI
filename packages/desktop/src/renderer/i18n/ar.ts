export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Octo Agent",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Octo Agent، هل ترغب في تثبيته وإعادة تشغيله؟",
