export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Octo Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Octo Agent. Czy chcesz ją zainstalować i uruchomić ponownie?",
