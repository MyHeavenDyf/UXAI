export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Octo Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Octo Agent er blevet downloadet. Vil du installere den og genstarte?",
